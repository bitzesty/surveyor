...
jQuery(document).ready(function(){
  ...
  $.extend(SurveyorAjax, {
    ...
    prototype: {
      ...
      setOptions: function() {
        this.options.type       = $('form#survey_form').attr("method").toUpperCase();
      ...
      hideElement: function( id ) {
        ...
        if(this.options.type === 'PUT'){
          // we don't need to issue additional request when we use
          // the POST version of the update endpoint (aka 'update and delete')
